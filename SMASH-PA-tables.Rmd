...
##Means only/empty models
#morning_mood <- lme(NAf_am ~ 1,   #Fixed effects portion of model
         #     data = day, #Which data to use
          #    random = ~1 |pid, #Random effects portion of model
         #     method="ML", #Estimation method
         #     na.action="na.omit") #missing data handling
#summary(morning_mood)
