...
NA_sm_sum_bayes  <- brm(NAf_am_p ~ sum_sm_p_lag + NAf_pm_p_lag + sum_sm_p_c + day_in_study + (1 | pid), prior = prior1, data = day)
...
NA_sm_count_bayes  <- brm(NAf_am_p ~ count_sm_p_lag + NAf_pm_p_lag + count_sm_p_c + day_in_study + (1 | pid), prior = prior1, data = day)
