...
NA_sm_sum_bayes  <- brm(NAf_pm_p ~ sum_sm_p + NAf_am_p + sum_sm_p_c + day_in_study + (1 + sum_sm_p | pid), prior = prior1, data = day)
...
NA_sm_count_bayes  <- brm(NAf_pm_p ~ count_sm_p + NAf_am_p + count_sm_p_c + day_in_study + (1 + count_sm_p | pid), prior = prior1, data = day)
...
PA_on_SM_day_bayes  <- brm(sum_sm_p ~ SM_Pos_p + SM_Pos_p_c + day_in_study + (1 + SM_Pos_p | pid), prior = prior1, data = day)
...
PA_on_SM_count_day_bayes  <- brm(count_sm_p ~ SM_Pos_p + SM_Pos_p_c + day_in_study + (1 + SM_Pos_p | pid), prior = prior1, data = day)
...
NA_on_SM_day_bayes  <- brm(sum_sm_p ~ SM_Neg_p + SM_Neg_p_c + day_in_study + (1 + SM_Neg_p | pid), prior = prior1, data = day)
...
NA_on_SM_count_day_bayes  <- brm(count_sm_p ~ SM_Neg_p + SM_Neg_p_c + day_in_study + (1 + SM_Neg_p | pid), prior = prior1, data = day)
