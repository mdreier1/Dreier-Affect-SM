...
key <- read.csv("C:/Users/Missy Dreier/Box/The Hamilton Lab/Studies- Complete or Collabs/SMASH Study/AWARE Sensing/SM Coding/SM_key_2.17.23.csv") # key for changing app var names
...
#knitr::kable(SMtable_yes_no_final, format = "latex") %>% row_spec(0, bold=TRUE)

kable(SMtable_yes_no_final)
...
## make nice table
knitr::kable(SMtable, format = "latex") %>% row_spec(0, bold=TRUE) 
